...
#ifndef TCPVEGASTWEAKED_H
#define TCPVEGASTWEAKED_H
...
class TcpVegasTweaked : public TcpNewReno
{
  public:
    /**
     ...
     */
    TcpVegasTweaked(const TcpVegasTweaked& sock);
    ~TcpVegasTweaked() override;
  ...
  private:
    ...
    double m_prevThroughput;      //!< Previous throughput
    double m_currentThroughput;   //!< Current throughput
